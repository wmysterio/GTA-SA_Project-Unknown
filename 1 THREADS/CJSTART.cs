...
public partial class MAIN {
    ...
    static sString CJ_CURRENT_MISSION_NAME;
    ...
    public class CJSTART : Thread {
        ...
        public override void START( LabelJump label ) {
            markerID.value = RadarIconID.CESAR_VIALPANDO;
            or( 
                CJ_TOTAL_MISSION_PASSED > 3
                //, X >  CJ_TOTAL_MISSION_PASSED,
            , delegate { markerID.value = RadarIconID.CJ; } );
        ...
        private void LOOP2( LabelJump label ) {
            ...
            __show_mission_name( CJ_CURRENT_MISSION_NAME );
            __fade( 0, false );
        ...
        private void SETUP_MISSION_NAMES( LabelGosub label ) {
            ...
            for( int i = 0; i < names.Length; i++ ) {
                and( CJ_TOTAL_MISSION_PASSED == i, delegate {
                    CJ_CURRENT_MISSION_NAME.value = names[ i ];
                } );
            }
        }
