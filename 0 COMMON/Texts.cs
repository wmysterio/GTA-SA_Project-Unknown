...
public static class Texts {
    public static void generate() {
        ...
        .add( "@PHS@04", "~p~Сальваторе:~s~ Собери всю сумму до цента, и Свит будет целым и не вредимым." )
        .add( "@PHS@05", "~p~CJ:~s~ Вы лжоте! Как только я принесу деньги, мы оба мертвецы." )
        .add( "@PHS@06", "~p~Сальваторе:~s~ Это тоже вероятно. Но у тебя нет выбора. Принему мне мои грёбанные деньги!" )

        .add( "@PHS@07", "~p~Джон:~s~ Здравстуйте, Карл Джонсон!" )
        .add( "@PHS@08", "~p~CJ:~s~ Кто это?" )
        .add( "@PHS@09", "~p~Джон:~s~ Офицер Маркоски. У меня есть пару серьёзных вопросов. Приходите в участок." )
        ...
        */
        ...
        #region CRASH REPLICS
        .add( "CRRE0", "~р~Джон:~s~ Несколько из моих друзей стали какие-то странные. Возможно я у них под подозрением." )
        .add( "CRRE1", "~р~Джон:~s~ Я попрошу тебя их завалить. Возьми тачку и убей их прежде, чем у них закончится патруль." )
        .add( "CRRE2", "~р~Джон:~s~ Тебе лучше взять пушку, чтобы не пришлось марать руки слишком долго." )
        .add( "CRRE3", "~р~СJ:~s~ Об этом можете не беспокоиться. Я сделаю это, а Вы потом расскажите, что знаете." )
        .add( "CRRE4", "~r~Вас заметила камера наблюдения!" )
        .add( "CRRE5", "~r~Вы не успели устранить цели вовремя!" )
        .add( "CRRE6", "~s~Убейте отмеченных ~r~копов~s~!" )
        .add( "CRRE7", "Друзья" )
        ...
        .add( "CRRE8", "~р~Джон:~s~ И не светись впереди мотоциклов. В них встроенная видеокамера." )
