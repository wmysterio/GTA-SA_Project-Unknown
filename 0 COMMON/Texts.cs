...
public static class Texts {
    public static void generate() {
        ...
        */
        ...
        .add( "@INC@18", "Инфицированные приближаются к ~g~прототипу~s~!" )
        .add( "@INC@19", "~r~Прототип был заражен!" )
        .add( "@INC@20", "Вы получили ключи к ~g~прототипу VITAL~s~. Он всегда будет доступен возле офиса компании." )
        .add( "@INC@21", "Убийств: ~1~" )

        // REPLICAS
        .add( "@IC@000", "~s~В этой сцене в ~g~прототипа~s~ закончилось топливо. Вам нужно не допустить к нему ~r~инфицированных~s~." )
